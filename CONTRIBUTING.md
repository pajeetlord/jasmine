Contributing to Jasmine Core
============================

The Jasmine Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Jasmine Core project, and is not to be
confused with overall Jasmine Network Protocol consensus changes.

Whether a pull request is merged into Jasmine Core rests with the project merge
...
Patches that change Jasmine consensus rules are considerably more involved than
...
Where a patch set proposes to change the Jasmine consensus, it must have been
...
The project leader is the release manager for each Jasmine Core release.
