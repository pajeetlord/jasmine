...
In order to support loading of multiple wallets in jasmine-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is jasmine.cpp.
...
Changes to jasmine.cpp
----------------------
jasmine.cpp is the entry point into jasmine-qt, and as such, will require some minor modifications to provide hooks for
