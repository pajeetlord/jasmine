...
RESOURCES += src/qt/jasmine.qrc src/qt/jasmine_locale.qrc

TRANSLATIONS += src/qt/locale/jasmine_bg.ts \
                src/qt/locale/jasmine_de.ts \
                src/qt/locale/jasmine_en.ts \
                src/qt/locale/jasmine_es.ts \
                src/qt/locale/jasmine_fi.ts \
                src/qt/locale/jasmine_fr.ts \
                src/qt/locale/jasmine_it.ts \
                src/qt/locale/jasmine_ja.ts \
                src/qt/locale/jasmine_pl.ts \
                src/qt/locale/jasmine_pt.ts \
                src/qt/locale/jasmine_ru.ts \
                src/qt/locale/jasmine_sk.ts \
                src/qt/locale/jasmine_sv.ts \
                src/qt/locale/jasmine_vi.ts \
                src/qt/locale/jasmine_zh_CN.ts \
                src/qt/locale/jasmine_zh_TW.ts
