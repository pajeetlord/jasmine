...
This means one can have an always-on jasmined instance running, and another local jasmined/jasmine-qt instance which connects to this node and receives blocks from it.
