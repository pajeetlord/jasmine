...
/** Utility functions used by the Jasmine Qt UI.
 */
namespace GUIUtil
{
...
// Render Jasmine addresses in monospace font
...
// Parse "jasmine:" URI into recipient object, return true on successful parsing
