...
/* Jasmine GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Jasmine"
#define QAPP_ORG_DOMAIN "jasmine.org"
#define QAPP_APP_NAME_DEFAULT "Jasmine-Qt"
#define QAPP_APP_NAME_TESTNET "Jasmine-Qt-testnet"
