...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Jasmine Core jasmine-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  jasmine-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jasmine transaction") + "\n" +
                               "  jasmine-tx [options] -create [commands]   " + _("Create hex-encoded jasmine transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded jasmine transaction
